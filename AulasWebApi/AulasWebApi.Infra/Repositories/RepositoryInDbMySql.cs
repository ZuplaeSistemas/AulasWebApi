...
namespace AulasWebApi.Infra.Repositories
{
    public class RepositoryInDbMySql<T> : IRepository<T> where T : BaseModel
    {
        ...
        public RepositoryInDbMySql(IDbConnectionFactory dbConnectionFactory)
        {
        ...
        public int Create(T entity)
        {
            ...
            using MySqlConnection connection = (MySqlConnection)this._dbConnectionFactory.GetConnection();
            ...
            using MySqlCommand insertCommand = new MySqlCommand(commandText, connection);
        ...
        public void Delete(int id)
        {
            ...
            using MySqlCommand deleteCommand = new MySqlCommand(commandText, connection);
        ...
        public bool Exists(int id)
        {
            ...
            using MySqlCommand existsCommand = new MySqlCommand(commandText, connection);
        ...
        public List<T> Read()
        {
            ...
            using MySqlCommand selectCommand = new MySqlCommand(commandText, connection);
        ...
        public void Update(T entity)
        {
            ...
            using MySqlCommand updateCommand = new MySqlCommand(commandText, connection);
