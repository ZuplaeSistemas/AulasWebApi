...
{
    internal class PersonServiceOld : Service<Person>
    {
        private IDbConnectionFactory _dataBase;

        public PersonServiceOld(IDbConnectionFactory dataBase): base(new PersonRepository())
        {
            this._dataBase = dataBase;
        }
        public PersonServiceOld(PersonRepository repository): base(repository)
        {
            
        }

        public int Create(Person model)
        {
